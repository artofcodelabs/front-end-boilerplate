...
class Nav extends React.Component {
  ...
  indexLink() {
    if (this.isOnIndex() && !this.isOnSubmenu()) return <b>Index</b>;
    return <a href="index.html">Index</a>;
  }

  page1Link() {
    if (this.props.page === "page1") return <b>Page 1</b>;
    return <a href="page1.html">Page 1</a>;
  }

  squaringLink() {
    if (this.props.active === "squaring") return <b>Squaring</b>;
    return <a href="squaring.html">Squaring</a>;
  }

  cubingLink() {
    if (this.props.active === "cubing") return <b>Cubing</b>;
    return <a href="cubing.html">Cubing</a>;
  }

  submenu() {
    if (!this.isOnIndex()) return "";
    return (
      <ul>
